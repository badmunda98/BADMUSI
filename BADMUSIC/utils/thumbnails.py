...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("BADMUSIC/assets/bad/font2.ttf", 30)
    font = ImageFont.truetype("BADMUSIC/assets/bad/font.ttf", 30)
    title_font = ImageFont.truetype("BADMUSIC/assets/bad/font3.ttf", 45)
    ...
    play_icons = Image.open("BADMUSIC/assets/bad/play_icons.png")
